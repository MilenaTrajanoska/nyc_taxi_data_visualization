...
public class GeoUtils {
    ...
    public static final double LON_WIDTH = Math.abs(LON_WEST) - Math.abs(LON_EAST);
    public static final double LAT_HEIGHT = Math.abs(LAT_NORTH) - Math.abs(LAT_SOUTH);
    ...
    public static final int NUMBER_OF_GRID_X = (int) Math.ceil(LON_WIDTH / DELTA_LON);
    ...
    public static Point getGridCellCenterPoint(float longitude, float latitude) {
